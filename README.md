...
### [(교수)이상치 보정을 활용한 BLE Beacon 기반의 실내 거리측정 기법 연구](https://github.com/YeonHeeLee98/Distance-Measurement-Algorithm)
  ...
  * 지도교수 :  김의직 
  * 참여기업 : 엠투테크(주)
 ### [(교수)LSTM 모델 기반 리튬이온 배터리 SOH 예측 모델](https://github.com/one4435/2020-02-CapstoneDesign)
  * 팀명 : 고하나   
  * 팀원 : 고하나
  * 지도교수 :  김의직
  * 참여기업 : 엠투테크(주) 
...
### [(업체)회사 업무 관리시스템](https://github.com/blackfourteen2014/CD_Project)
  * 팀명 : BlackFourTeen
  * 팀원 : 김경민, 신종현, 김동준, 오정식
  * 지도교수 : 이원철  
  * 참여기업 : (일본기업) 씨밀레, IT프리즈     
...
### [(교수)WiFi 서비스 관리 시스템 개발](https://github.com/Maengdeul/Hallym-Capstone-Wifi)
  ...
  * 지도교수 : 김태운  
  * 참여기업 : ㈜레이니스트
### [(교수)형광측정 PCR 장치의 양성 판정 기준](https://github.com/HUN9709/PCR)
  * 팀명 : 정29현
  * 팀원 : 윤성훈, 정구현, 이우열, 길병헌
  * 지도교수 : 김종대 
  * 참여기업 : ㈜ 바이오메듀스
